...
public class Paciente {
	...
	@Size(min = 1, message = "Apellidos debe tener minimo 3 caracteres")
	@Column(name = "apellidos", nullable = false, length = 70)
	private String apellidos;

	@ApiModelProperty(notes = "DNI debe tener 8 caracteres")
	@Size(min = 1, max = 8, message = "DNI debe tener 8 caracteres")
	@Column(name = "dni", nullable = false, length = 8)
	private String dni;

	@ApiModelProperty(notes = "Dirección debe tener minimo 3 caracteres")
	@Size(min = 1, max = 150, message = "Dirección debe tener minimo 3 caracteres")
	@Column(name = "direccion", nullable = true, length = 150)
	private String direccion;	
	
	@ApiModelProperty(value = "Telefono debe tener 9 caracteres")
	@Size(min = 1, max = 9, message = "Telefono debe tener 9 caracteres")
